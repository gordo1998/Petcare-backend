...
(
idDiasNoDisponible int,
mes int,
dia int,
hora time,
cuidadorDiaNoDisponible int,
constraint pk_diasNoDisponibles primary key (idDiasNoDisponible),
constraint fk_diasNoDisponibles foreign key (cuidadorDiaNoDisponible) references cuidador(idCuidador)
...
# Debe tener la fecha y la hora de la reserva. Debe tener la ubicación donde se realizará el servicio. No tiene que 
# ser exacta. 
